...
export default function MesEntretiens() {
  ...
  const fetchEntretiens = async () => {
    try {
      const data = await api('/entretiens/candidat/mes');
  ...
  if (loading) {
    return (
      <CandidatLayout title="Mes Entretiens">
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          <div style={styles.headerLeft}>
            <h1 style={styles.headerTitle}>Mes entretiens</h1>
            <p style={styles.headerSubtitle}>
              Suivez vos entretiens planifiés avec les recruteurs
            </p>
          </div>
        </div>
        ...
        {filtered.length === 0 ? (
          <div style={styles.emptyState}>
            ...
            <p>
              Vous serez notifié lorsqu'un recruteur vous contactera pour un entretien.
              Préparez-vous en mettant à jour votre profil et vos compétences !
            </p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div style={styles.cardLeft}>
                    <div style={{
                      ...styles.avatar,
                      background: getAvatarColor(e.recruteur?.nom || e.offre?.entrepriseId?.nom),
                    }}>
                      {getInitials(e.recruteur?.nom || e.offre?.entrepriseId?.nom)}
                    </div>
                    <div style={styles.interviewInfo}>
                      <div style={styles.jobTitle}>
                        {e.offre?.titre || 'Entretien'}
                      </div>
                      <div style={styles.companyName}>
                        {Icons.building}
                        {' '}
                        {e.recruteur?.nom || e.offre?.entrepriseId?.nom || 'Entreprise'}
                      </div>
